...
EDGES = [
    ...
    ("C04", "C04-N0", "C04-N3", "change color, change title, add background"),
    ("C05", "C05-N0", "C05-N1", "change title, add background, add annotation"),
    ...
    ("C09", "C09-N0", "C09-N3", "change color, add background"),
    ...
    ("C17", "C17-N1", "C17-N3", "add annotation, add background"),
...
OP_NORM = {
    ...
    "change visual background": "add background",
}
...
OP_L1 = {
    ...
    "add background": "Visual", "simplify axis": "Visual",
...
PLAT_COLOR = {
    ...
    "News Media": "#D46A6A",
    "Social Media": "#5C9ECE",
    "Personal Blog": "#8CB86E",
    "Data Platform": "#C8A850",
    "Online Community": "#D8885C",
    "Research Inst.": "#6AB0A0",
    "Inst. Blog": "#B888B8",
}
...
plat_order = {
    "Gov/Intl Org": 0, "Research Inst.": 1, "Data Platform": 2,
...
for (s, t, l1_cat), val in link_agg.items():
    ...
    link_clr.append(f"rgba({r},{g},{b},0.35)")
...
for l1_name, l1_clr in L1_COLOR.items():
    fig.add_annotation(
        ...
        text=f"<b>■</b> {l1_name}",
        showarrow=False,
        font=dict(size=10, color=l1_clr, family="Arial"),
        xref="paper", yref="paper",
        xanchor="left",
    )
    l1_legend_x += 0.08
